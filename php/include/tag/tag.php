<?php
    ...
    class MP3Tag
    {
        ...
        (
            ...
            115 => "Folklore", 116 => "Ballad", 117 => "Power Ballad", 118 => "Rhythmic Soul", 119 => "Free Style",
            120 => "Duet", 121 => "Punk Rock", 123 => "A capella", 124 => "Euro-House",
            ...
            135 => "Beat", 136 => "Christian Gangsta", 137 => "Heavy Metal", 138 => "Black Metal", 139 => "Crossover",
            140 => "Contemporary C", 141 => "Christian Rock", 142 => "Merengue", 143 => "Salsa", 144 => "Thrash Metal",
        ...
        public function tags($filename)
        {
            ...
            {
                $tags["title"] = trim(substr($id3, 3, 30));
                $tags["artist"] = trim(substr($id3, 33, 30));
                $tags["album"] = trim(substr($id3, 63, 30));
                $tags["year"] = trim(substr($id3, 93, 4));
                $tags["comment"] = trim(substr($id3, 97, 28));
                $tags["track"] = ord($id3[126]);
                if(ord($id3[127]) < 148)
                {
                    $tags["genre"] = $this->genre[ord($id3[127])];
                }
            }
            fclose($fp);
            return $tags;
